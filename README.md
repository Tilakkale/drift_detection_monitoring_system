...
The dashboard is the operator view of the application. It shows the results produced by the running API:
...
Evaluation results generated by the application:
...
A video is not included yet because no recording file exists in the repository. The correct recording should show the running app opening, API status, **Drift Analysis** results, **Model Evaluation** results, and **Monitor** anomaly results. Add the real MP4 as `docs/media/dashboard-demo.mp4` or attach it to a GitHub issue/pull request before linking it here.
